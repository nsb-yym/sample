...
public class CopyOfCopyOfCopyOfCopyOfccc123BaseAutomationLogic extends BaseAutomationLogic {
	...
	public void xmlParser(ParameterSet globalParameterSet) throws AutomationFailException {//!findOffset_xmlParser!

	}
	public void xmlParseronExceptionOccured(ParameterSet globalParameterSet, InvokingInfo invokingInfo, Throwable e, InvokingErrorInfo errorInfo) throws AutomationFailException {
